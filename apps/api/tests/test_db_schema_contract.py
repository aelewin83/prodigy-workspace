...
def test_phase1_migration_contains_required_tables():
    migration = Path("alembic/versions/0001_phase1_schema.py").read_text(encoding="utf-8")
...
def test_phase2_boe_display_fields_migration_exists():
    migration = Path("alembic/versions/0003_boe_test_display_fields.py").read_text(encoding="utf-8")
...
def test_gate_state_and_audit_fields_migration_exists():
    migration = Path("alembic/versions/0004_gate_state_and_audit_fields.py").read_text(encoding="utf-8")
